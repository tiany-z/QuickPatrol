...
import { handleReviewDelayApply } from "./handler.js";
import { returnError } from "../../../../shared/flow/result.js";

export const api: ApiEndpointModule = {
  routePath: "/api/patrol/delay/review",
  authRequired: true,
  handler: async (data: HttpRequestData, ctx: RequestContext) => {
    ...
    return handleReviewDelayApply({ schoolId, userId, role, ip, realName }, data.body);
  }
};
