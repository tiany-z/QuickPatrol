...
import { handleGetMasterReputation } from "./handler.js";
import { returnError } from "../../../../shared/flow/result.js";

export const api: ApiEndpointModule = {
  routePath: "/api/patrol/feedback/master-reputation",
  authRequired: true,
  handler: async (data: HttpRequestData, ctx: RequestContext) => {
    ...
    return handleGetMasterReputation({ schoolId, userId, role, ip, realName }, data.query || {});
  }
};
