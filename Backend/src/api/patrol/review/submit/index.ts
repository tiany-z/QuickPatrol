...
import { handleSubmitPatrolReview } from "./handler.js";
import { returnError } from "../../../../shared/flow/result.js";

export const api: ApiEndpointModule = {
  routePath: "/api/patrol/review/submit",
  authRequired: true,
  handler: async (data: HttpRequestData, ctx: RequestContext) => {
    ...
    const permissions = ctx.userPayload?.permissions || (ctx as any).permissions || [];
    ...
    return handleSubmitPatrolReview(
