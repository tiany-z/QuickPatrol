/**
 * 高校后勤巡查e速办 v4.0 - POST /api/school/settings/test-llm 网关元数据定义
 * (School LLM Ping Probe API Endpoint Module)
 */

import { ApiEndpointModule, HttpRequestData, RequestContext } from "../../../../dispatcher/gatewayTypes.js";
import { handleTestLlmConnectivity } from "./handler.js";
import { returnError } from "../../../../shared/flow/result.js";

export const api: ApiEndpointModule = {
  routePath: "/api/school/settings/test-llm",
  authRequired: true,
  handler: async (data: HttpRequestData, ctx: RequestContext) => {
    ...
    return handleTestLlmConnectivity({ schoolId, userId, userRole }, data.body || {});
  }
};
