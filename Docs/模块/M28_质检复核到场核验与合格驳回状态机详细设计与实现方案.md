...
> **驱动下游**：M29 (满意度五星评价与超时自动好评结案), M30 (工单综合大宽表视图与全景详情对比轴), M44 (全校后勤宏观效能驾驶舱)  
> **版本日期**：2026-09-05  
...
### 向下游模块（M29、M30、M44）交付的标准接口与数据契约：
...
3. **宏观质量效能画像**：为 M44（后勤驾驶舱）提供全校各外包队伍与维修工种的“一次复核合格率（FPY）”与“返工率”宏观报表。
