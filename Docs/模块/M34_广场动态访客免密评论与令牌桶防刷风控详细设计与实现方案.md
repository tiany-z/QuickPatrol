...
> **驱动下游**：M35 (广场动态点赞互动与官方公告置顶), M42 (统一消息总线待办卡片), M44 (全校后勤宏观效能驾驶舱)  
> **版本日期**：2026-09-05  
...
| :--- | :--- | :---: | :--- |
| **`posts.commentCount`** | `number` | M35, M44 | 动态累计评论总量，作为 M35 重力热榜算法与 M44 舆情大屏的核心输入 |
| **`latestCommentAuthor`** | `string` | M35 | 最新评论者昵称，用于在广场动态卡片展示“最新互动滚动浮条” |
| **`tokenBucketStats`** | `JSON Object` | M44 | 全校各 IP 令牌桶限流拦截频次，直供后勤安全运维网络风控看板 |
